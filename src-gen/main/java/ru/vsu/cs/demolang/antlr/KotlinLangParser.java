...
public class KotlinLangParser extends Parser {
	...
	public static final int
		...
		SAFE_CALL=26, ELVIS=27, NOT_NULL=28, NUMBER=29, TRUE=30, FALSE=31, ID=32, 
		STRING=33, COMMENT=34, LINE_COMMENT=35, WS=36, MUL=37, DIV=38, REM=39, 
		ADD=40, SUB=41, GT=42, GE=43, LT=44, LE=45, EQ=46, NE=47;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"TRUE", "FALSE", "ID", "STRING", "COMMENT", "LINE_COMMENT", "WS", "MUL", 
			"DIV", "REM", "ADD", "SUB", "GT", "GE", "LT", "LE", "EQ", "NE"
		};
	}
	...
	public final ProgContext prog() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2215697696272L) != 0)) {
				{
				setState(38);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public static class PrimaryContext extends ParserRuleContext {
		...
		public TerminalNode TRUE() { return getToken(KotlinLangParser.TRUE, 0); }
		public TerminalNode FALSE() { return getToken(KotlinLangParser.FALSE, 0); }
		public TerminalNode ID() { return getToken(KotlinLangParser.ID, 0); }
		public List<ExprContext> expr() {
			return getRuleContexts(ExprContext.class);
		}
	...
	public final PrimaryContext primary() throws RecognitionException {
		...
		try {
			...
			case 5:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2215666368528L) != 0)) {
					{
					setState(202);
					expr(0);
					setState(207);
	...
	public final PrefixOpContext prefixOp() throws RecognitionException {
		...
		try {
			...
			setState(236);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 2199023370240L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
